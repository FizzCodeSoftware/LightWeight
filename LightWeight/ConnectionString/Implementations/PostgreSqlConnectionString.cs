...
public class PostgreSqlConnectionString(string name, string connectionString, string version = null)
    : BaseAdoNetSqlConnectionString(AdoNetEngine.PostgreSql, DefaultProviderName, name, connectionString, version)
{
