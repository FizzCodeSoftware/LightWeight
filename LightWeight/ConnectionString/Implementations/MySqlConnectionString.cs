...
public class MySqlConnectionString(string name, string connectionString, string version = null)
    : BaseAdoNetSqlConnectionString(AdoNetEngine.MySql, DefaultProviderName, name, connectionString, version)
{
